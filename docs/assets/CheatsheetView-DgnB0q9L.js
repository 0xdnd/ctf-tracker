import{r as n,j as e,aD as K,C as de,T as he,d as ce,aC as Se,X as Qe,ah as Bt,af as Dt,aW as Wt,aX as Xe,aR as Ut,aK as Vt,aY as Gt,e as He,$ as et,aU as zt,aZ as qt,aF as Kt,a_ as Yt,A as Xt,F as Jt,am as Zt,a$ as Qt,W as $t,aO as _e,b0 as Re,B as je,R as Nt,E as er,b1 as tr,s as Je,D as rr,N as sr,u as ar,n as nr,g as Pe,i as or,aI as ft,b2 as lr,al as ir,b3 as cr,a2 as dr,au as pr,f as yt,ar as mr,k as ur,ae as xr}from"./vendor-framework-Dpe2BZp9.js";import{S as hr,p,i as fe,d as Ze,u as Be,a as wt,n as br}from"./index-2OC1M9QW.js";import{p as gr,a as fr,r as vt,b as kt,C as St,c as yr,d as wr,s as vr,e as kr,f as Sr,h as Ae,i as Ne}from"./obsidianManualUtils-DhvxmQPj.js";import{m as re}from"./vendor-ui-Bo53bknG.js";import"./vendor-utils-oQXWb4Lk.js";import"./tracks-data-y2k3R6DB.js";import"./methodology-data-CbduTmc6.js";import"./cpts-vault-data-CUuU5G9N.js";const $r=({note:a,globalVars:C,soundEnabled:B,onClose:g,onNavigateToNote:D,onDeleteNote:L,defaultLanguage:ne="en"})=>{const[U,u]=n.useState("reading"),[E,F]=n.useState(ne),[X,oe]=n.useState(null),[v,A]=n.useState({}),[R,Z]=n.useState({}),$=n.useMemo(()=>gr(a.rawMarkdown||""),[a.rawMarkdown]),pe=n.useMemo(()=>fr(a.id),[a.id]);n.useMemo(()=>!$.callouts||$.callouts.length===0?[]:$.callouts.filter(i=>{const c=/[\u0590-\u05FF]/.test(i.title+" "+i.content);return E==="he"?c:!c}),[$.callouts,E]);const M=n.useRef(null);n.useEffect(()=>{var i;(i=M.current)==null||i.focus()},[a.id]),n.useEffect(()=>{const i=c=>{c.key==="Escape"&&(c.preventDefault(),c.stopPropagation(),g())};return window.addEventListener("keydown",i,!0),()=>window.removeEventListener("keydown",i,!0)},[g]);const Y=(i,c)=>{navigator.clipboard.writeText(i),oe(c),B&&p("copy"),setTimeout(()=>oe(null),2e3)},y=()=>{if(!a.commands||a.commands.length===0)return;const i=a.commands.map(c=>fe(c,C)).join(`
