  ...
  return (
    <div className="w-full space-y-5 font-mono">
      ...
      <div className="p-4 rounded-xl border border-slate-200 dark:border-cyber-border bg-white dark:bg-cyber-card/90 shadow-xl space-y-4">
        ...
        {/* Telemetry Bar */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-3 border-t border-slate-200 dark:border-cyber-border/80">
          ...
          <div className="p-3.5 rounded-lg bg-slate-50 dark:bg-cyber-bg border border-slate-200 dark:border-cyber-border flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 dark:text-white tracking-widest mt-0.5 font-mono">
          ...
          <div className="p-3.5 rounded-lg bg-slate-50 dark:bg-cyber-bg border border-slate-200 dark:border-cyber-border flex items-center justify-between gap-2">
            <button
              onClick={handleNewMockSet}
              className="flex-1 py-2 px-3 rounded-lg bg-white dark:bg-cyber-card border border-cyan-400/40 text-cyan-800 dark:text-cyber-cyan hover:bg-cyan-400 hover:text-black dark:hover:bg-cyber-cyan dark:hover:text-black font-bold text-xs transition-all flex items-center justify-center gap-1.5"
            ...
            <button
              ...
              className="flex-1 py-2 px-3 rounded-lg bg-emerald-100 dark:bg-cyber-emerald/20 border border-emerald-300 dark:border-cyber-emerald/50 text-emerald-900 dark:text-cyber-emerald hover:bg-emerald-500 hover:text-white dark:hover:bg-cyber-emerald dark:hover:text-black font-bold text-xs transition-all flex items-center justify-center gap-1.5 shadow-glow-emerald/20"
